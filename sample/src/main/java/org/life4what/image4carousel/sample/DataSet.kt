...
object DataSet {
    ...
    val five = listOf(
        R.drawable.image_1 to "Smokin' Burger",
        R.drawable.image_2 to "Beef Masala Curry",
        R.drawable.image_3 to "Egg Curry",
        R.drawable.image_4 to "Mixed Juice",
        R.drawable.image_5 to "Cheese Sandwich",
        R.drawable.image_6 to "Ice Cream",
    )
